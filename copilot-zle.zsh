...
export COPILOT_ZLE_ROOT_DIR="${_COPILOT_ZLE_DIR}"
export COPILOT_ZLE_PLUGIN_PATH="${_COPILOT_ZLE_DIR}/copilot-zle.zsh"
export COPILOT_ZLE_CONFIG_FILE="${COPILOT_ZLE_CONFIG_FILE:-${_COPILOT_ZLE_DIR}/config.json}"
